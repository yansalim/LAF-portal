              ...
              <article key={user.id} className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                <div className="space-y-2 text-sm text-slate-600">
                  <div>
                    ...
                    <p className="text-base font-semibold text-slate-900">{user.nome}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p>{allowedCategoriesLabel(user)}</p>
                  </div>
                  <div>
                    <p className="text-xs uppercase text-slate-500">Atualizado</p>
                    <p>{user.atualizadoEm ? formatDateTime(user.atualizadoEm) : '—'}</p>
                  </div>
                </div>
